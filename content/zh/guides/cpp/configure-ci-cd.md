---
title: 为您的 C++ 应用程序配置 CI/CD
linkTitle: 配置 CI/CD
weight: 40
keywords: ci/cd, github actions, c++, shiny
description: 学习如何使用 GitHub Actions 为您的 C++ 应用程序配置 CI/CD。
aliases:
...
完成本指南的所有前置章节，从[容器化 C++ 应用程序](containerize.md)开始。您必须拥有 [GitHub](https://github.com/signup) 账户和 [Docker](https://hub.docker.com/signup) 账户才能完成本节内容。
