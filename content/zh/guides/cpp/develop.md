...
description: 学习如何在本地开发您的 C++ 应用程序。
aliases:
...
要测试它，请在您喜欢的文本编辑器中打开 `ok_api.cpp` 文件，将消息从 `{"Status" : "OK"}` 更改为 `{"Status" : "Updated"}`。保存文件并在 [http://localhost:8080](http://localhost:8080) 刷新浏览器。您应该看到更新后的消息。
