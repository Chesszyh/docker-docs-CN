---
title: 掌握用户和访问管理
summary: 简化用户访问，同时确保 Docker 的安全性和效率。
description: 管理角色、配置用户以及使用 SSO 和活动日志等工具优化 Docker 访问的指南。
tags: [admin]
params:
  featured: true
  time: 20 minutes
...
管理角色和权限是保护 Docker 环境安全的关键，同时可以实现轻松协作和运营效率。本指南引导 IT 管理员了解用户和访问管理的基础知识，提供分配角色、配置用户以及使用活动日志和洞察分析等工具来监控和优化 Docker 使用的策略。
