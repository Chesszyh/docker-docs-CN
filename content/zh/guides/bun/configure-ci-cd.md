...
description: 了解如何为你的 Bun 应用程序使用 GitHub Actions 配置 CI/CD。
aliases:
...
完成本指南的所有前面部分，从 [容器化 Bun 应用程序](containerize.md) 开始。你必须拥有 [GitHub](https://github.com/signup) 帐户和 [Docker](https://hub.docker.com/signup) 帐户才能完成本节。
...
在本节中，你学习了如何为你的 Bun 应用程序设置 GitHub Actions 工作流程。
