...
Compose 文件格式的最新推荐版本由 [Compose 规范](_index.md)定义。此格式合并了 2.x 和 3.x 版本，并在 **Compose 1.27.0+** 中实现。有关更多信息，请参阅 [Docker Compose 的历史和发展](/manuals/compose/intro/history.md)。
