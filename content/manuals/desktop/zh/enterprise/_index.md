...
Docker Desktop Enterprise（DDE）已被弃用，不再进行活跃开发。请改用 [Docker Desktop](../_index.md) 社区版。

如果您是现有的 DDE 客户，请使用我们的[支持表单](https://hub.docker.com/support/desktop/)申请过渡到我们新的[订阅计划](https://www.docker.com/pricing)之一。
